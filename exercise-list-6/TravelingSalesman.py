...
class NearestNeighbour(object):
    ...
    def __init__(self,initial_node,cost_matrix):
        ...
        self.cost_matrix_array = np.array(cost_matrix)
        self.n = self.cost_matrix_array.shape[0]
        self.path = []
        self.path_costs = []
        self.total_cost = 0
        pass
    ...
    def get_nearest_neighbour(self, node):
        neighbours_distance = self.cost_matrix_array[node-1]
